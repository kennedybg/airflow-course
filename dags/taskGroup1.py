...
dag = DAG('task_group_1', description="Task group 1",
...
task6 = BashOperator(task_id="tsk6", bash_command="sleep 2", dag=dag)

tsk_group = TaskGroup("tsk_group", dag=dag)

task7 = BashOperator(task_id="tsk7", bash_command="sleep 2", dag=dag, task_group=tsk_group)
task8 = BashOperator(task_id="tsk8", bash_command="sleep 2", dag=dag, task_group=tsk_group)

task9 = BashOperator(task_id="tsk9", bash_command="sleep 2", dag=dag, task_group=tsk_group,
