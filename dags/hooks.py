...
dag = DAG('hook', description="Hook",
          schedule_interval=None, start_date=datetime(2023, 11, 9), catchup=False, tags=['hook'])
...
select_data_task = PythonOperator(
    task_id="select_data_task", python_callable=select_data, provide_context=True, dag=dag)
